...
class Agent(object):
    def __init__(self, path):
        ...
        self.targetQ = net.FFNet(self.learning_rate)
        ...
        # how manty times the agent calls the train functions - used for target network replacement
    ...
    def update(self, r, id_curr, id_next, a_index):
        ...
        target[0][a_index] = r + self.decay_rate * max(self.targetQ(next_state).detach()[0])
        return target.cpu()
